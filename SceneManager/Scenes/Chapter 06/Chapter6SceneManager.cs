...
{
    internal class Chapter6SceneManager: IStorySceneManager, IChapterSceneManager
    {
        private Player Player;
        public Chapter6SceneManager(Player player)
        {
            Player = player;
        }
        ...
        {
            ScreenRenderer.RenderAnimation(new Chapter6Screen());
