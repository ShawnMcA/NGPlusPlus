...
{
    internal class Chapter11SceneManager: IStorySceneManager, IChapterSceneManager
    {
        private Player Player;
        public Chapter11SceneManager(Player player)
        {
            Player = player;
        }
        public void PlaySet()
        ...
        {
            ScreenRenderer.RenderAnimation(new Chapter11Screen());
